...
// Problem ----------------------------------------------------------------------------
  ...
  requires class Problem
  {
	public:
		...
		int dimension() const;
		float ** vehicles_info() const;//Matriz de 3*cant_vehiculos
		int cant_vehiculos() const;

		float ** clients_info() const;//Matriz de 6*cant_clientes
		int cant_clientes() const;
...
//Solution ----------------------------------------------------------------------------
  ...
  requires class Solution
  {
	...
	private:
		Rarray<int> _var; //array de tam cant_clientes + 2*cant_camiones
		const Problem& _pbm;
  };
